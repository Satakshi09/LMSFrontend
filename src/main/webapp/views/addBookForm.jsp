...
background: rgba(73, 226, 222, 1.0);
background: -webkit-radial-gradient(bottom right, rgba(73, 226, 222, 1.0), rgba(201, 1, 255, 1.0));
background: -moz-radial-gradient(bottom right, rgba(73, 226, 222, 1.0), rgba(201, 1, 255, 1.0));
background: radial-gradient(to top left, rgba(73, 226, 222, 1.0), rgba(201, 1, 255, 1.0));
	/* Make image center */
